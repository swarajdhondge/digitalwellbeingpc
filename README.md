...
<p align="center">
  <!-- Auto-updates on every release: GitHub redirects this "latest" URL to the newest
       release's demo.gif (attached by .github/workflows/release.yml; recorded via
       scripts/record-demo.ps1). -->
  <img src="https://github.com/swarajdhondge/digitalwellbeingpc/releases/latest/download/demo.gif" alt="Pulse demo — a quick tour of the dashboard, screen time, app usage, hearing, focus, and insights" width="800"/>
</p>
